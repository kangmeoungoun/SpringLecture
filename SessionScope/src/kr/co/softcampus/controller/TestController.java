...
public class TestController {
	...
	public DataBean1 sesionBean1() {
		return new DataBean1();
	}
	@ModelAttribute("sessionBean2")
	public DataBean1 sesionBean2() {
		return new DataBean1();
	}
	...
	@GetMapping("/test4")
	public String test4(HttpSession sessison) {
		DataBean1 bean1  =  new DataBean1();
		bean1.setData1("문자열4");
		bean1.setData2("문자열5");
		sessison.setAttribute("bean1", bean1);
		return "test4";
	}
	@GetMapping("/result4")
	//public String result4(HttpSession sessison) {
		public String result4(@SessionAttribute("bean1") DataBean1 bean1) {
	    //DataBean1 bean1  =  (DataBean1)sessison.getAttribute("bean1");

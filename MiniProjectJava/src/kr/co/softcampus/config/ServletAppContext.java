...
import kr.co.softcampus.interceptor.CheckWriterInteceptor;
...
public class ServletAppContext implements WebMvcConfigurer {
	...
	//Controller 의 메서드가 반환하는 jsp의 이름 앞뒤에 경로와 확장자를 붙혀주도록 설정한다.
	@Override
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		CheckWriterInteceptor checkWriterInteceptor = new CheckWriterInteceptor(loginUserBean, boardService);
		InterceptorRegistration reg3= registry.addInterceptor(checkWriterInteceptor);
